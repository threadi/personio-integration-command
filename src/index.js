...
dispatch( commandsStore ).registerCommandLoader( {
  ...
  hook: useMyCommandLoader,
} );

/**
 * Add our custom command to load positions in command palette.
 *
 * @param search
 * @returns {{commands: *, isLoading: *}}
 */
function useMyCommandLoader( {search } ) {
